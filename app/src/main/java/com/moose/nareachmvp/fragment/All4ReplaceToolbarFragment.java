...
public class All4ReplaceToolbarFragment
    ...
    protected View initView() {
        view = View.inflate(getActivity(), R.layout.fragment_all2, null);
...
//        mRecyclerView.setLayoutManager(new AutoHeightLinearLayoutManager(getActivity()));
    ...
    private void initToolbar() {
        mToolBar = (Toolbar) view.findViewById(R.id.moose_toolbar);
        mToolBar.setBackgroundColor(getBaseActivity().getNareachApp().getCurrentColor());
        getBaseActivity().setSupportActionBar(mToolBar);
//        getBaseActivity().getSupportActionBar().collapseActionView();
    }
